<template><section><h2 id="customize-theme"><a class="header-anchor" href="#customize-theme" aria-hidden="true">¶</a> Customize Theme</h2>
<p>Vue-Blu allows to custom themes so as to meet the  user's personalized needs.Only need the front-end build environment
supports sass compilation without the need for any other additional tools.You can configure fonts, colors, borders,
backgrounds, and so on by defining sass variables. Here's how:</p>
<h4 id="how"><a class="header-anchor" href="#how" aria-hidden="true">¶</a> How</h4>
<p>1.Set the sass variables and import the entry file of the library</p>
<pre><code class="language-javascript">$blue: #<span class="hljs-number">3</span>c81df;
$turquoise: #<span class="hljs-number">00</span>c0ef;
$red: #f56954;
$green: #<span class="hljs-number">6</span>cc788;
$orange: #f2a654;
$purple: #<span class="hljs-number">926</span>dde;
$yellow: #f39c12;
<span class="hljs-comment">// import the entry file</span>
@import <span class="hljs-string">"~vue-blu/src/scss/blu"</span>
</code></pre>
<p>2.Import the variables file (Suppose the path is <code>'path/to/css/variables.scss'</code>)</p>
...
<span class="hljs-keyword">import</span> VueBlu <span class="hljs-keyword">from</span> <span class="hljs-string">'vue-blu'</span>
<span class="hljs-keyword">import</span> <span class="hljs-string">'path/to/css/variables.scss'</span>

Vue.use(VueBlu)

</code></pre>
<h4 id="variables"><a class="header-anchor" href="#variables" aria-hidden="true">¶</a> Variables</h4>
