...
<p>Vue-Blu 可以轻松实现自定义主题，从而满足使用者个性化的需求。只需要前端构建环境支持<code>sass</code>编译，无需安装另外的工具。可通过定义sass变量的方式配置字体、颜色、边框、背景等。方法如下：</p>
<h4 id="fang-fa"><a class="header-anchor" href="#fang-fa" aria-hidden="true">¶</a> 方法</h4>
<p>1.自定义变量，并引入组件库样式入口文件(假设路径为<code>'path/to/css/variables.scss'</code>)</p>
...
<h4 id="zhi-chi-bian-liang-biao"><a class="header-anchor" href="#zhi-chi-bian-liang-biao" aria-hidden="true">¶</a> 支持变量表</h4>
