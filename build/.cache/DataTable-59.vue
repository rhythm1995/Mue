...
<ul>
<li>指定数据源 <code>data</code> 为一个数组</li>
<li><code>column</code> 组件为table设置列</li>
<li>对于某些简单的场景，也可以使用原生table标签 + 样式的方式展示table。需要在table标签上加<code>class=&quot;table&quot;</code>的css样式，配合<code>is-bordered``is-striped``is-narrow</code>实现边框、斑马纹、迷你版的设置</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> &gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"姓名"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"name"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"工号"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"work_no"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"生日"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"birthday"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"Email"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"email"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"性别"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"gender"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"成绩"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"achievement"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">data-table</span>&gt;</span>
...
<h4 id="bian-kuang-he-ban-ma-wen"><a class="header-anchor" href="#bian-kuang-he-ban-ma-wen" aria-hidden="true">¶</a> 边框和斑马纹</h4>
...
<data-table :data="dataSource2" :bordered="bordered" :striped="striped" :narrow="narrow">
  ...
  <column label="成绩" field="achievement"></column>
                    ...
                    <div slot="description"><h4 id="bordered-he-striped"><a class="header-anchor" href="#bordered-he-striped" aria-hidden="true">¶</a> bordered 和 striped</h4>
<ul>
<li>设置 <code>bordered</code> 为 <code>true</code>，为表格设置边框</li>
<li>设置 <code>striped</code> 为 <code>true</code>，可设置斑马纹显示</li>
<li>设置 <code>narrow</code> 为 <code>true</code>，显示窄的table</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> <span class="hljs-attr">:bordered</span>=<span class="hljs-string">"bordered"</span> <span class="hljs-attr">:striped</span>=<span class="hljs-string">"striped"</span> <span class="hljs-attr">:narrow</span>=<span class="hljs-string">"narrow"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">table-toolbar</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"left"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">b-switch</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">"bordered"</span>&gt;</span>边框<span class="hljs-tag">&lt;/<span class="hljs-name">b-switch</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">b-switch</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">"striped"</span>&gt;</span>斑马纹<span class="hljs-tag">&lt;/<span class="hljs-name">b-switch</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">b-switch</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">"narrow"</span>&gt;</span>narrow<span class="hljs-tag">&lt;/<span class="hljs-name">b-switch</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
...
<h4 id="gu-ding-biao-tou"><a class="header-anchor" href="#gu-ding-biao-tou" aria-hidden="true">¶</a> 固定表头</h4>
...
<data-table :data="dataSource2" bordered="" :height="280">
  ...
  <column label="成绩" field="achievement"></column>
                    ...
                    <div slot="description"><h4 id="gu-ding-biao-tou"><a class="header-anchor" href="#gu-ding-biao-tou" aria-hidden="true">¶</a> 固定表头</h4>
<ul>
<li>为table设置一个高度后，表头会自动固定</li>
<li>可通过 <code>width</code> 设置列的宽度</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> <span class="hljs-attr">bordered</span> <span class="hljs-attr">:height</span>=<span class="hljs-string">"280"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"姓名"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"name"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"工号"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"work_no"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"生日"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"birthday"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"Email"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"email"</span> <span class="hljs-attr">:width</span>=<span class="hljs-string">"200"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"性别"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"gender"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"成绩"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"achievement"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">data-table</span>&gt;</span>
</code></pre>
...
<h4 id="pai-xu"><a class="header-anchor" href="#pai-xu" aria-hidden="true">¶</a> 排序</h4>
...
<data-table :data="dataSource2" bordered="">
  ...
  <column label="成绩" field="achievement" sorter="custom"></column>
                    ...
                    <div slot="description"><h4 id="pai-xu"><a class="header-anchor" href="#pai-xu" aria-hidden="true">¶</a> 排序</h4>
<ul>
<li>为table设置一个高度后，表头会自动固定</li>
<li>可通过 <code>width</code> 设置列的宽度</li>
</ul>
                    ...
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> <span class="hljs-attr">bordered</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"姓名"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"name"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"工号"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"work_no"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"生日"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"birthday"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"Email"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"email"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"性别"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"gender"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"成绩"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"achievement"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">data-table</span>&gt;</span>
</code></pre>
</div>
                  <summary>
...
<h4 id="biao-ge-gong-ju-lan"><a class="header-anchor" href="#biao-ge-gong-ju-lan" aria-hidden="true">¶</a> 表格工具栏</h4>
...
<data-table :data="dataSource2" bordered="">
  ...
  <column label="成绩" field="achievement" sorter="custom"></column>
                    ...
                    <div slot="description"><h4 id="table-toolbar"><a class="header-anchor" href="#table-toolbar" aria-hidden="true">¶</a> table-toolbar</h4>
<ul>
<li>为table添加工具栏</li>
<li><code>has-refresh</code> 是否显示刷新按钮</li>
<li><code>has-columns-control</code> 是否显示表格列控制按钮</li>
<li><code>slot=&quot;left&quot;</code> 添加左对齐的项目；* <code>slot=&quot;right&quot;</code> 添加右对齐的项目，配合 <code>class=&quot;level-item&quot;</code>使用，可参考示例</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> <span class="hljs-attr">bordered</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">table-toolbar</span> <span class="hljs-attr">has-refresh</span> <span class="hljs-attr">has-columns-control</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"left"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button is-primary"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"icon is-small"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fa fa-edit"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span>&gt;</span>查看<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"right"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"control has-addons"</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"input"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Find a post"</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span>&gt;</span>Search<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
...
<h4 id="lie-mo-ban"><a class="header-anchor" href="#lie-mo-ban" aria-hidden="true">¶</a> 列模板</h4>
...
<data-table :data="dataSource2" bordered="">
  ...
  <column label="成绩" field="achievement" sorter="custom"></column>
                    ...
                    <div slot="description"><h4 id="zi-ding-yi-lie-mo-ban"><a class="header-anchor" href="#zi-ding-yi-lie-mo-ban" aria-hidden="true">¶</a> 自定义列模板</h4>
<ul>
<li>通过 <code>scopeSlot</code> 实现，用法见示例中代码</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html">
<span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource2"</span> <span class="hljs-attr">bordered</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"工号"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"work_no"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"生日"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"birthday"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"Email"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">scope</span>=<span class="hljs-string">"row"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">tag</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span>&gt;</span><span>{{</span> row.email <span>}}</span><span class="hljs-tag">&lt;/<span class="hljs-name">tag</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
...
<h4 id="zong-he-yan-shi"><a class="header-anchor" href="#zong-he-yan-shi" aria-hidden="true">¶</a> 综合演示</h4>
<demo-box :jsfiddle="{&quot;html&quot;:&quot;&lt;data-table :data=\&quot;dataSource\&quot; :change=\&quot;onTableChange\&quot; :on-select-change=\&quot;onSelectChange\&quot; checkable=\&quot;\&quot; show-index=\&quot;\&quot; :pagination=\&quot;pagination\&quot; bordered&gt;\n  &lt;table-toolbar has-refresh=\&quot;\&quot; has-columns-control&gt;\n    &lt;template slot=\&quot;left\&quot;&gt;\n      &lt;div class=\&quot;level-item\&quot;&gt;\n        &lt;a class=\&quot;button is-primary\&quot; @click=\&quot;handleEdit\&quot; :class=\&quot;{'is-disabled': !hasSelect}\&quot;&gt;&lt;span class=\&quot;icon is-small\&quot;&gt;&lt;i class=\&quot;fa fa-edit\&quot;&gt;&lt;/i&gt;&lt;/span&gt;&lt;span&gt;查看&lt;/span&gt;&lt;/a&gt;\n      &lt;/div&gt;\n    &lt;/template&gt;\n    &lt;template slot=\&quot;right\&quot;&gt;\n      &lt;div class=\&quot;level-item\&quot;&gt;\n        &lt;p class=\&quot;control has-addons\&quot;&gt;\n          &lt;input class=\&quot;input\&quot; type=\&quot;text\&quot; placeholder=\&quot;Find a post\&quot;&gt;\n          &lt;button class=\&quot;button\&quot;&gt;Search&lt;/button&gt;\n        &lt;/p&gt;\n      &lt;/div&gt;\n    &lt;/template&gt;\n  &lt;/table-toolbar&gt;\n  &lt;column label=\&quot;姓名\&quot;&gt;\n    &lt;template scope=\&quot;row\&quot;&gt;\n      &lt;span&gt;{{ row.name }}&lt;/span&gt;\n    &lt;/template&gt;\n  &lt;/column&gt;\n  &lt;column label=\&quot;工号\&quot; field=\&quot;work_no\&quot; sorter=\&quot;custom\&quot;&gt;&lt;/column&gt;\n  &lt;column label=\&quot;生日\&quot; field=\&quot;birthday\&quot; sorter=\&quot;custom\&quot;&gt;&lt;/column&gt;\n  &lt;column label=\&quot;Email\&quot; field=\&quot;email\&quot;&gt;&lt;/column&gt;\n  &lt;column label=\&quot;性别\&quot; field=\&quot;gender\&quot;&gt;&lt;/column&gt;\n  &lt;column label=\&quot;成绩\&quot; field=\&quot;achievement\&quot; sorter=\&quot;custom\&quot;&gt;&lt;/column&gt;\n&lt;/data-table&gt;\n&lt;modal title=\&quot;查看\&quot; :width=\&quot;520\&quot; :is-show=\&quot;isShow\&quot; transition=\&quot;fadeDown\&quot; @close=\&quot;isShow=false\&quot;&gt;\n  &lt;h4&gt;选中了：&lt;/h4&gt;\n  &lt;p&gt;\n    &lt;ul&gt;\n      &lt;li v-for=\&quot;item in selectedItems\&quot;&gt;\n        {{ item.name }}({{ item.work_no }} | {{ item.email }})\n      &lt;/li&gt;\n    &lt;/ul&gt;\n  &lt;/p&gt;\n&lt;/modal&gt;\n&quot;,&quot;script&quot;:null,&quot;style&quot;:null}">
                    <div class="box-demo-show" slot="component"><data-table :data="dataSource" :change="onTableChange" :on-select-change="onSelectChange" checkable="" show-index="" :pagination="pagination" bordered="">
  <table-toolbar has-refresh="" has-columns-control="">
    <template slot="left">
      <div class="level-item">
        <a class="button is-primary" @click="handleEdit" :class="{'is-disabled': !hasSelect}"><span class="icon is-small"><i class="fa fa-edit"></i></span><span>查看</span></a>
    ...
    <ul>
      <li v-for="item in selectedItems">
        {{ item.name }}({{ item.work_no }} | {{ item.email }})
                    ...
                    <div slot="description"><h4 id="zong-he-yan-shi"><a class="header-anchor" href="#zong-he-yan-shi" aria-hidden="true">¶</a> 综合演示</h4>
<ul>
<li>设置 <code>pagination</code> 参数显示分页，支持 <code>pagination</code> 组件的所有参数</li>
<li>对于选中的行，可通过<code>on-select-change</code>的回调获取到选中的行的key值和数据</li>
<li>当设置table的<code>checkable</code>为true时，请指定一列的key作为唯一键<code>rowKey</code>。若没有指定，可能会出现未知错误</li>
</ul>
</div>
                    <div class="highlight" slot="code"><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource"</span> <span class="hljs-attr">:change</span>=<span class="hljs-string">"onTableChange"</span> <span class="hljs-attr">:on-select-change</span>=<span class="hljs-string">"onSelectChange"</span> <span class="hljs-attr">checkable</span> <span class="hljs-attr">show-index</span> <span class="hljs-attr">:pagination</span>=<span class="hljs-string">"pagination"</span> <span class="hljs-attr">bordered</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">table-toolbar</span> <span class="hljs-attr">has-refresh</span> <span class="hljs-attr">has-columns-control</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"left"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button is-primary"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"handleEdit"</span> <span class="hljs-attr">:class</span>=<span class="hljs-string">"{'is-disabled': !hasSelect}"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"icon is-small"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fa fa-edit"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span>&gt;</span>查看<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"right"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">table-toolbar</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"姓名"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">scope</span>=<span class="hljs-string">"row"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">span</span>&gt;</span><span>{{</span> row.name <span>}}</span><span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">template</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"工号"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"work_no"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"生日"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"birthday"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"Email"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"email"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"性别"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"gender"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">column</span> <span class="hljs-attr">label</span>=<span class="hljs-string">"成绩"</span> <span class="hljs-attr">field</span>=<span class="hljs-string">"achievement"</span> <span class="hljs-attr">sorter</span>=<span class="hljs-string">"custom"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">column</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">data-table</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">modal</span> <span class="hljs-attr">title</span>=<span class="hljs-string">"查看"</span> <span class="hljs-attr">:width</span>=<span class="hljs-string">"520"</span> <span class="hljs-attr">:is-show</span>=<span class="hljs-string">"isShow"</span> <span class="hljs-attr">transition</span>=<span class="hljs-string">"fadeDown"</span> <span class="hljs-attr">@close</span>=<span class="hljs-string">"isShow=false"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">h4</span>&gt;</span>选中了：<span class="hljs-tag">&lt;/<span class="hljs-name">h4</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">v-for</span>=<span class="hljs-string">"item in selectedItems"</span>&gt;</span>
        <span>{{</span> item.name <span>}}</span>(<span>{{</span> item.work_no <span>}}</span> | <span>{{</span> item.email <span>}}</span>)
...
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">data-table</span> <span class="hljs-attr">:data</span>=<span class="hljs-string">"dataSource"</span> <span class="hljs-attr">:change</span>=<span class="hljs-string">"onTableChange"</span> <span class="hljs-attr">:on-select-change</span>=<span class="hljs-string">"onSelectChange"</span> <span class="hljs-attr">checkable</span> <span class="hljs-attr">show-index</span> <span class="hljs-attr">:pagination</span>=<span class="hljs-string">"pagination"</span> <span class="hljs-attr">bordered</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">table-toolbar</span> <span class="hljs-attr">has-refresh</span> <span class="hljs-attr">has-columns-control</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">template</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"left"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"level-item"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button is-primary"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"handleEdit"</span> <span class="hljs-attr">:class</span>=<span class="hljs-string">"{'is-disabled': !hasSelect}"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"icon is-small"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fa fa-edit"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span>&gt;</span>查看<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
...
<h4 id="datatable"><a class="header-anchor" href="#datatable" aria-hidden="true">¶</a> DataTable</h4>
<table>
<thead>
<tr>
<th>成员</th>
...
<tr>
<td>pagination</td>
<td>分页配置项，参数参考 <code>pagination</code> 组件</td>
<td>Object</td>
<td>无</td>
</tr>
<tr>
<td>rowKey</td>
<td>表格行的 <code>key</code>，用于checkbox选择</td>
<td>String</td>
<td>无</td>
</tr>
<tr>
...
<td>选中或取消选中某一行时的回调</td>
<td>Function（selectedRowKeys, selectedRows）</td>
<td>无</td>
</tr>
</tbody>
</table>
<h4 id="column"><a class="header-anchor" href="#column" aria-hidden="true">¶</a> Column</h4>
<table>
<thead>
<tr>
<th>成员</th>
...
<tr>
<td>sorter</td>
<td>是否排序，设置为true时为远程排序，值为<code>custom</code>时为客户端排序</td>
<td>Boolean, Function, String</td>
<td>无</td>
</tr>
</tbody>
</table>
